      ...
      <div>
        ...
        <div style={{ display: "flex" }}>
          ...
          <ClickableTile
            ...
            category="Others"
          />
          {/* <ClickableTile imagePath="https://th.bing.com/th?id=OIP.CyL21c24YlmvVJD4PMa9-wHaHa&w=250&h=250&c=8&rs=1&qlt=90&o=6&dpr=1.3&pid=3.1&rm=2" /> */}
          {/* <ClickableTile imagePath="https://th.bing.com/th?id=OIP.CyL21c24YlmvVJD4PMa9-wHaHa&w=250&h=250&c=8&rs=1&qlt=90&o=6&dpr=1.3&pid=3.1&rm=2" /> */}
          {/* Add more clickable tiles here */}
        </div>
        {/* <input type="text" placeholder = "If Others, please specify" style={{position: "absolute", top:"200px", left: "10px"}}  /> */}
      </div>
    );
  }
}
